...
export const getInitialMessages = (): Immutable.Map<Uuid, IMessage> => Immutable.Map({
  [messageId1]: new Message({
    ...
    likes: Immutable.List<Uuid>([harryId]),
    dislikes: Immutable.List<Uuid>([sallyId]),
  }),
  [messageId2]: new Message({
    ...
    likes: Immutable.List<Uuid>([harryId, sallyId]),
  ...
  [messageId3]: new Message({
    ...
    authorId: sallyId,
    channelId: gossipChannelId,
    likes: Immutable.List<Uuid>([janeId]),
    dislikes: Immutable.List<Uuid>([harryId]),
  }),
  [messageId4]: new Message({
    ...
    authorId: janeId,
    channelId: offTopicChannelId,
    likes: Immutable.List<Uuid>([harryId, janeId, sallyId]),
    dislikes: Immutable.List<Uuid>(),
  }),
  ...
  [messageId8]: new Message({
    ...
    authorId: janeId,
    channelId: offTopicChannelId,
    likes: Immutable.List<Uuid>([harryId, sallyId, janeId]),
    dislikes: Immutable.List<Uuid>(),
  }),
